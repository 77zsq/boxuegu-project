...
function getFormData() {
    ...
    console.log(formArrData); //数组中有很多对象
    var formData = {};
    for (var i = 0, len = formArrData.length; i < len; i++) {
        formData[formArrData[i].name] = formArrData[i].value; //{ct_id:"1", "ct_name":"介绍", "ct_video_duration":"3:12"}
        console.log(formArrData[i].value);
    }
    console.log(formData);
    return formData;
}
